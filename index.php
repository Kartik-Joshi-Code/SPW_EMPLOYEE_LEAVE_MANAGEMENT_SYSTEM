...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">SPW_PROJECT</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons">account_box</i>Employee Password Recovery</a></li>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>SPW_PROJECT</h4></div>
        ...
        <script src="https://www.google.com/recaptcha/api.js?render=6LfeWuoUAAAAAMt6kHU8kRyFnJEXgbTfdVdNPLJo"></script>
<script>
grecaptcha.ready(function() {
    grecaptcha.execute('6LfeWuoUAAAAAMt6kHU8kRyFnJEXgbTfdVdNPLJo', {action: 'homepage'}).then(function(token) {
